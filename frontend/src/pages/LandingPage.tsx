...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#060c0e] bg-earth-grid text-slate-100 flex flex-col justify-between selection:bg-emerald-500 selection:text-black">
      ...
      {/* Footer */}
      <footer className="border-t border-[#1c353d] bg-[#060c0e]/90 py-8 px-6 text-center text-xs text-slate-500">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <Globe className="w-4 h-4 text-emerald-400" />
            <span className="font-bold text-slate-300">Darukaa.Earth</span>
            <span>— Precision Geospatial Environmental Analytics</span>
          </div>
